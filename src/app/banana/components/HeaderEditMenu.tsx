        ...
        <div className="absolute inset-x-2 top-full  mt-3 flex justify-between">
          <button 
            ...
            className={`flex items-center gap-2 rounded-md ${
              activeMenu === "element" ? "bg-white" : "bg-white/90"
            } px-4 py-2 text-sm font-medium text-gray-700 shadow-lg transition-all hover:bg-white`}
          >
          ...
          <button 
            ...
            className={`flex items-center gap-2 rounded-md ${
              activeMenu === "design" ? "bg-white" : "bg-white/90"
            } px-4 py-2 text-sm font-medium text-gray-700 shadow-lg transition-all hover:bg-white`}
          >
            <MdOutlineStyle className="text-lg" />
            Design
