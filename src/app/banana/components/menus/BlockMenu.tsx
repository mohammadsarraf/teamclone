...
const BlockMenu: React.FC<BlockMenuProps> = ({
    ...
    Basic: [
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M4 6H20M4 10H20M4 14H12M4 18H8"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M12 4V20M8 8V16M4 10V14M16 7V17M20 9V15"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
    ...
    Media: [
      ...
      },
      {
        ...
        icon: (
          ...
          >
            <path
              d="M10 11H6V7H10V11ZM10 17H6V13H10V17ZM18 11H14V7H18V11ZM18 17H14V13H18V17Z"
              fill="currentColor"
            />
          </svg>
        ),
    ...
    Advanced: [
      {
        ...
        icon: (
          ...
          >
            ...
            />
            <path
              d="M12 21L17.5 15.5C19.5 13.5 19.5 10.5 17.5 8.5C15.5 6.5 12.5 6.5 10.5 8.5C8.5 10.5 8.5 13.5 10.5 15.5L12 17"
              stroke="currentColor"
              strokeWidth="2"
            />
          </svg>
      ...
      },
      {
        ...
        icon: (
          ...
          >
            ...
            />
            <path
              d="M4 12V16C4 18.2091 5.79086 20 8 20H16C18.2091 20 20 18.2091 20 16V12"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
      ...
      },
      {
        ...
        icon: (
          ...
          >
            ...
            />
            <path
              d="M7 7V17H9V12L11 15L13 12V17H15V7H13L11 10L9 7H7Z"
              fill="currentColor"
            />
          </svg>
        ),
      ...
      },
      {
        ...
        icon: (
          ...
          >
            ...
            />
            <path
              d="M8 2V6M16 2V6M3 10H21M8 14H10M14 14H16M8 18H10M14 18H16"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
  ...
  const filteredBlocks = Object.entries(blockTemplates).reduce(
    (acc, [category, blocks]) => {
  ...
  return (
    <div
      className="block-menu fixed z-50 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg"
      style={{
    ...
    >
      ...
      <div className="border-b border-gray-200 p-3">
        <div className="relative">
          ...
          <input
            type="search"
            className="block w-full rounded-md border border-gray-300 bg-gray-50 p-2 pl-10 text-sm text-gray-900 focus:border-indigo-500 focus:ring-indigo-500"
            placeholder="Search"
            value={searchQuery}
      ...
      {!searchQuery && (
        <div className="flex flex-wrap border-b">
          {categories.map((category) => (
            <button
              key={category}
              className={`px-3 py-2 text-center text-sm font-medium ${activeCategory === category ? "border-b-2 border-indigo-600 text-indigo-600" : "text-black hover:text-indigo-500"}`}
              ...
              <div className="grid grid-cols-2 gap-2">
                {blocks.map((block, index) => (
                  <button
                    ...
                    className="flex items-center gap-2 rounded-md border border-gray-200 p-2 text-left transition-colors hover:bg-gray-50"
