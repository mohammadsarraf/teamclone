...
const ItemActionMenu: React.FC<ItemActionMenuProps> = ({
  ...
  return (
    <div className=" z-50 flex items-center divide-x divide-gray-200 rounded-md border border-gray-200 bg-white text-black shadow-md">
      {/* Pencil/Edit Button */}
      <button
      ...
      >
        ...
        >
          <path
            d="M7 14c-1.66 0-3-1.34-3-3 0-1.31.84-2.41 2-2.83V8c0-2.21 1.79-4 4-4s4 1.79 4 4v.17c1.16.42 2 1.52 2 2.83 0 1.66-1.34 3-3 3H7z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      {/* Delete Button */}
      <button
        className="p-2 transition-colors hover:bg-gray-50 hover:text-red-500"
        onClick={onDelete}
        title="Delete"
      >
        <svg
