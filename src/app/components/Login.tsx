...
const Login = ({ user }: any) => {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center" style={{ background: 'linear-gradient(to bottom, #1a1a1a, #000)' }}>
            {error && <p className="mx-auto max-w-md rounded-md bg-red-700 p-2 text-center text-red-500">{error}</p>}
            <div className="w-full max-w-4xl rounded-lg bg-[#1e1e1e] p-10 shadow-lg">
                <div className="mb-6 text-center">
                    <p className="text-2xl font-semibold text-gray-200">Log in to TeamGlu4e.com</p>
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                        <div className="mb-1 p-1">
                            <label htmlFor="email" className="mb-2 block text-left text-sm font-medium text-gray-400">
                        ...
                        <div className="mb-1 p-1">
                            <label htmlFor="password" className="mb-2 block text-left text-sm font-medium text-gray-400">
                                Password
                            </label>
                            <input
                                type="password"
                    ...
                    <div className="flex-1 space-y-4">
                        <button className="flex w-full items-center gap-4 rounded-lg border border-gray-600 bg-[#2a2a2a] px-6 py-3 hover:bg-[#3b3b3b]">
                            ...
                            <span className="flex-1 text-base font-medium leading-none text-gray-200">Continue with Google</span>
                        </button>
                        <button className="flex w-full items-center gap-4 rounded-lg border border-gray-600 bg-[#2a2a2a] px-6 py-3 hover:bg-[#3b3b3b]">
                            <FaApple className="size-6 text-gray-300" />
                            <span className="flex-1 text-base font-medium leading-none text-gray-200">Continue with Apple</span>
                        </button>
                        <button className="flex w-full items-center gap-4 rounded-lg border border-gray-600 bg-[#2a2a2a] px-6 py-3 hover:bg-[#3b3b3b]">
                            <FaGithub className="size-6 text-gray-200" />
                            <span className="flex-1 text-base font-medium leading-none text-gray-200">Continue with GitHub</span>
                        </button>
                        <button className="flex w-full items-center gap-4 rounded-lg border border-gray-600 bg-[#2a2a2a] px-6 py-3 hover:bg-[#3b3b3b]">
                            <FaEnvelope className="size-6 text-yellow-500" />
                            <span className="flex-1 text-base font-medium leading-none text-gray-200">Email me a login link</span>
                        </button>
                        <button className="flex w-full items-center gap-4 rounded-lg border border-gray-600 bg-[#2a2a2a] px-6 py-3 hover:bg-[#3b3b3b]">
                            <FaPiedPiperPp className="size-6 text-green-400" />
                            <span className="flex-1 text-base font-medium leading-none text-gray-200">Log in via PiedPiper</span>
                        </button>
                    </div>
                </div>
