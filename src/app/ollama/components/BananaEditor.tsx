...
export default function BananaEditor({
  ...
  useEffect(() => {
    if (headerState) setGlobalHeaderState(headerState);
  }, [headerState, setGlobalHeaderState]);

  useEffect(() => {
    if (contentState) setGlobalContentState(contentState);
  }, [contentState, setGlobalContentState]);

  useEffect(() => {
    if (footerState) setGlobalFooterState(footerState);
  }, [footerState, setGlobalFooterState]);
