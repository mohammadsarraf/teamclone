...
const TemplateList = () => {
  return (
    <section className="w-3/4 h-screen overflow-y-auto p-5 bg-white custom-scrollbar">
      <h2 className="text-xl font-bold mb-4 text-black ml-4">Templates</h2> {/* Added ml-4 to align with sidebar */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {templates.map((template) => (
          <div key={template.name} className="border p-4 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-300">
